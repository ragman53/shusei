...
//! with tract-onnx inference runtime (migrated from ort in S07).
...
pub use engine::{OcrEngine, OcrResult, TextRegion};
pub use engine_tract::NdlocrEngineTract as NdlocrEngine;
